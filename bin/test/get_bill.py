...
BLCSV = os.path.join(path,'etc','apps','SplunkAppforAWS','log','billinfo.csv')
BLTMP1 = os.path.join(path,'etc','apps','SplunkAppforAWS','log','billinfo1.txt')
BLTMP2 = os.path.join(path,'etc','apps','SplunkAppforAWS','log','billinfo1.csv')
BLFINAL = os.path.join(path,'etc','apps','SplunkAppforAWS','log','billinfo.txt')
...
try:
        ...
        fERRFL.write(now+' S3ResponseError '+str(emsg1[0])+' '+emsg1[1]+' '+str(emsg1[2])+'\n')
